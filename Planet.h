...
class Planet
{
    ...
    void copy(const Planet & other)
    {
        ...
        /*if (citizens.getSize() > other.citizens.getSize() )
        {
        citizens.setSizeLong(other.citizens.getSize());
        citizens.setCapacity(other.citizens.getCapacity());
        }
        else 
        {
        citizens.setCapacity(other.citizens.getCapacity());
        citizens.setSizeShort(other.citizens.getSize());
        }
