...
void Planet::promote_jedi(const char* jedi_name, double multiplier)
{
    ...
    else
    {
        ...
        if ((multiplier > 0) && (this->citizens[index].getRank() != GRAND_MASTER))
        { 
        ...
        {
            std::cout << "Multiplier must be a positive number/ Jedi rank is Grand Master" << std::endl;
        }
    }
}
void Planet::demote_jedi(const char* jedi_name, double multiplier)
{
    ...
    {
        if ((multiplier > 0) && (this->citizens[index].getRank() != YOUNGLING))
        {
        ...
        {
            std::cout << "Multiplier must be a positive number/ Jedi rank is Youngling" << std::endl;
        }
    }
}
