...
unsigned int Jedi::getAge() const
{
    return this->age;
}
char *Jedi::getColour() const
{
...
void Jedi::power_down(double multiplier) //we cannot have a Jedi with negative power!
{
    this->power -= (multiplier * this->power);
    if (this->power < 0)
    {
